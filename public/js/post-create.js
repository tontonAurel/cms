...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__mixins_bread_js__ = __webpack_require__(427);
...
var app = new Vue({
    el: '#post-create',
    mixins: [__WEBPACK_IMPORTED_MODULE_0__mixins_preloader_js__["a" /* default */], __WEBPACK_IMPORTED_MODULE_1__mixins_form_js__["a" /* default */], __WEBPACK_IMPORTED_MODULE_2__mixins_bread_js__["a" /* default */]],
    data: function data() {
        return {
            post: {
                'date': window.old.date || __WEBPACK_IMPORTED_MODULE_3_moment___default()().format('YYYY-MM-DD'),
