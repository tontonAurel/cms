...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_quill_editor__ = __webpack_require__(414);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__mixins_form_js__ = __webpack_require__(168);
...
var app = new Vue({
    el: '#post-create',
    mixins: [__WEBPACK_IMPORTED_MODULE_0__mixins_preloader_js__["a" /* default */], __WEBPACK_IMPORTED_MODULE_1__mixins_form_js__["a" /* default */]],
    data: function data() {
        return {
            bread: window.bread,
            post: {
                'date': window.old.date || __WEBPACK_IMPORTED_MODULE_2_moment___default()().format('YYYY-MM-DD'),
